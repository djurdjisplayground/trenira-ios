...
struct ConsultationDisclaimerView: View {
    var body: some View {
        HStack(alignment: .top, spacing: 10) {
            ...
            Text(ConsultationConfig.scopeNotice)
        ...
        .accessibilityLabel("Safety and professional scope")
        .accessibilityValue(ConsultationConfig.scopeNotice)
    }
}
